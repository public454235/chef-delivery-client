...
import chef from '../../assets/cheff-tr.png'
...
const CardDetails = () => {
    return (
        ...
        <div className='d-lg-flex align-items-center my-5'>
            ...
            <div className='ms-2'>
                <h3 className='fw-bold text-danger-emphasis'>Welcome To Our Restaurant </h3>
                <h1><span className='fw-bold text-black'>Amazing & Delicious Food
